...
import { ArrowLeft, FileText, Sparkles, TrendingUp, TrendingDown, AlertTriangle, CheckCircle2, Trophy, Share2 } from "lucide-react";
...
const RESULTS: DayResult[] = [
  { day: "Jumaat", date: "2 Mei", forecast: 806, actual: 870, weather: "☀️ Cerah" },
  { day: "Sabtu", date: "3 Mei", forecast: 884, actual: 720, weather: "🌧️ Hujan petang" },
  { day: "Ahad", date: "4 Mei", forecast: 0, actual: 0, weather: "⚪ Tutup" },
];
...
export function AutopsyReport({
  ...
  const [eventName] = useState("Bazar Ramadhan Hujung Minggu");
  ...
  const losses = useMemo(() => {
    ...
    if (stats.variance < 0) arr.push({ title: "Stok berlebihan", desc: `${boss} mungkin sediakan lebih bahan dari diperlukan — semak Pengurus Sisa Bijak.` });
    return arr;
  }, [stats, boss]);
